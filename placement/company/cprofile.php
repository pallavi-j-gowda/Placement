...
<div class="page-header"><h2>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to our site.</h2></div>
<form method="post">
<table  align="center" style="border-radius:30px; width:40%;" class="box">
    ...
    <tr>
      <td><label>webaddress</label></td>
      <td><input type="text" name="email" value="<?php echo $row['webaddress']; ?>"  class="box" readonly></td>
    </tr>
    <tr>
      <td><label>INTERVIEW DATE</label></td>
      <td><input type="date" name="date" value="<?php echo $row['date']; ?>"  class="box" readonly></td>
    </tr>
    <tr>
    ...
    <tr><td><a href="cupdate.php?id=<?php echo $row["id"]; ?>" class="ln btn btn-primary">Update</a></td><td><a href="creset.php" class="ln btn btn-warning">Reset Password</a></td></tr>
  </table>
  <br/><br/>
</form>
<br/><br/>
