...
<head>
        ...
        <style type="text/css">
          ...
          .tab{width:300px; height:50px; margin: auto; border-radius: 30px;}
...
<form action="insert.php" method="post">
  <h2>Enter the Student detailes</h2>
<table  align="center" style="border-radius:30px; width:50%;" class="tab">
<div class="col-lg-6 col-md-6 form-group">
    <tr><td><label class="text-muted font-weight-bold">STUDENT NAME</label></td><td><input type="text" name="username" class="tab1" ></td>
    <td><label class="text-muted font-weight-bold">EMAIL</label></td><td><input type="text" name="email"  class="tab1"></td></tr>
</div>
<div class="col-lg-6 col-md-6 form-group">
    <tr><td><label class="text-muted font-weight-bold">Phone Number</label></td><td><input type="text" name="phoneno" class="tab1"></td>
    <td><label class="text-muted font-weight-bold">Address</label></td><td><input type="text" name="address"  class="tab1"></td></tr>
    </div>
<div class="col-lg-6 col-md-6 form-group">
    <tr><td><label class="text-muted font-weight-bold">branch</label></td><td><select class="tab1" name="branch" required>
    ...
    <td><label class="text-muted font-weight-bold">sem</label></td><td><select class="tab1" name="sem" required>
            <option selected></option>
            <option>1</option>
            <option>2</option>
            <option>3</option>
...
<div class="col-lg-6 col-md-6 form-group">
    <tr><td><label class="text-muted font-weight-bold">Father name</label></td><td><input type="text" name="fathername" class="tab1"></td>
    <td><label class="text-muted font-weight-bold">Mother name</label></td><td><input type="text" name="mothername"  class="tab1"></td></tr>
    </div>
<div class="col-lg-6 col-md-6 form-group">
    <tr><td><label class="text-muted font-weight-bold">Date of brith</label></td><td><input type="date" name="dob" class="tab1"></td>
    <td><label class="text-muted font-weight-bold">Aggregate</label></td><td><input type="text" name="aggre"  class="tab1"></td></tr>
</div>
    <tr><td></td><td><label class="text-muted font-weight-bold">Password</label></td><td><input type="password" name="password" class="tab1"></td></tr>

    <tr style="text-align:center;"><td></td><td><input type="submit" class="ln btn btn-primary" value="Submit"></td><td></td><td><a href="sadd.php"  class="ln btn btn-primary" class="text-center">Cancel</a></td></tr>
  </table>                   
</form>
<br/><br/><br/>
