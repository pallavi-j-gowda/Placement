...
<div class="page-header"><h1>Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to our site.</h1></div>
<table  align="center" style="border-radius:30px; width:50%;" >
  <div class="col-lg-6 col-md-6 form-group">
  <tr>
    <td><label class="text-muted font-weight-bold" >NAME</label></td><td><input type="text" name="name" value="<?php echo $row['username']; ?>" class="tab1"></td>
    <td><label class="text-muted font-weight-bold" >EMAIL</label></td><td><input type="email" name="email" value="<?php echo $row['email']; ?>" class="tab1"></td>
  </tr>
  </div>
  <div class="col-lg-6 col-md-6 form-group">
  <tr>
    <td><label class="text-muted font-weight-bold" >CONTACT</label></td><td><input type="text" name="phoneno" value="<?php echo $row['phoneno']; ?>" class="tab1"></td>
    <td><label class="text-muted font-weight-bold" >ADDRESS</label></td><td><input type="text" name="address" value="<?php echo $row['address']; ?>" class="tab1"></td>
  </tr>
  </div>
  <div class="col-lg-6 col-md-6 form-group">
    
  <tr><td></td><td><label class="text-muted font-weight-bold" >BRANCH</label></td><td><select class="tab1" name="branch" required>
  ...
  <tr><td></td><td><a href="aupdate.php?id=<?php echo $row["id"]; ?>" class="ln btn btn-primary">Update</a></td><td></td><td><a href="#" class="ln btn btn-primary">cancel</a></td></tr>
</table>  
<br/><br/><br/>
