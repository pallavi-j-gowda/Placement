...
if(count($_POST)>0) {
mysqli_query($link,"UPDATE users set id='" . $_POST['id'] . "', username='" . $_POST['username'] . "', email='" . $_POST['email'] . "',phoneno='" . $_POST['phoneno'] . "', address='" . $_POST['address'] . "',branch='" . $_POST['branch'] . "',password='" . $_POST['password'] . "' WHERE id='" . $_POST['id'] . "'");
...
<div class="col-lg-6 col-md-6 form-group">
  <tr><input type="hidden" name="id" class="txtField" value="<?php echo $row['id']; ?>"></td>
  <td><label>Name:</label></td><td><input type="text" class="tab1" name="username" value="<?php echo $row['username'];?>" ></td>
  <td><label>email:</label></td><td><input type="email" class="tab1" name="email" value="<?php echo $row['email']; ?>" ></td></tr>
</div>
<div class="col-lg-6 col-md-6 form-group">
  <tr><td><label>phoneno:</label></td><td><input type="text" class="tab1" name="phoneno" value="<?php echo $row['phoneno']; ?>"></td>
  <td><label>address:</label></td><td><input type="text" class="tab1" name="address" value="<?php echo $row['address']; ?>" ></td></tr>
  </div>
<div class="col-lg-6 col-md-6 form-group">
  <tr><td><label>branch:</label></td><td><select type="text" class="tab1" value="<?php echo $row['branch']; ?>" name="branch" required>
  ...
  <td><label>Password:</label></td><td><input type="password" class="tab1" name="password" value="<?php echo $row['password']; ?>" ></td></tr>
  </div>
  <tr><td></td><td><button type="submit" class="ln btn btn-primary" name="btn-update" id="btn-update" onClick="update()"><strong>Update</strong></button></td><td></td><td><a href="aprofile.php"><button type="button" class="ln btn btn-primary" value="button">Cancel</button></a></td></tr>
</table>
</form>
<br/><br/><br/>
