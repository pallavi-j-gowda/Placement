...
<section>
  ...
  <div class="col-lg-6 col-md-6 form-group">
    <td><label class="control-label templatemo-block">BRANCH</label></td><td><select name="branch" class="tab1" >  
    ...
    <td><label class="control-label templatemo-block">Semester</label></td><td><select name="sem" class="tab1" >  
    ...
    <td><label class="control-label templatemo-block">Aggregate</label></td><td><input type="text" name="aggre"  id="aggre" placeholder="aggregate in perecentage" class="tab1" ></td>
  </div>
  </tr>
    <tr><td></td><td></td><td><button type="submit" name="submit" class="ln btn btn-primary">submit</button></td><td><button type="reset" class="ln btn btn-primary">Reset</button></td></tr></table>     
  </form>
</section>
