...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3a4750;" >
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02"style="margin-left:200px;">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item active"><a  class="link nav-link" href="login.php"><i class="fa fa-fw fa-home"></i>Admin login</a> </li>
    ...
    <h2>Login</h2><p>Please fill in your credentials to login.</p>
        <table class="tab">
            <tr>
                <td><label><b>username</b></label></td>
                <td><input type="text" class="tab1" name="username" placeholder="username" required="required"></td>
            </tr>
            <tr>
                <td><label><b>Password</b></label></td>
                <td><input type="password" class="tab1" name="password" placeholder="Password" required="required"><br/></td>
                
            </tr>
            <tr><td><button type="submit" name="save" class="ln btn btn-primary">Login</button></td>
            <td><a href="register.php" class="ln btn btn-primary">Sign up</a></td></tr>
        </table>
</form>
