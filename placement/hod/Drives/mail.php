		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>SRI KRISHAN PLOYTECNIC COLLEGE</h4>
					<p>JANAPRIYA APARTMENT,
						<span>CHIKKABANAVAR,BANGALORE, KARANATAKA</span>
						India 
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: +91 8088400938
						<span>E-mail:<a href="https://mail.google.com/mail/u/1/?view=cm&fs=1&to=principal.skp@gamil.com&tf=1">principal.skp@gamil.com</a></span>
					</p>
				</div>
