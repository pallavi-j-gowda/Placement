...
<div>
<h1 align="center">users details Details</h1>
...
if($result->num_rows != 0){
 ...
 <td><a href="adminUpdate.php?id=<?php echo $row['id']; ?>" alt="edit" class="ln">Update</a><a href="adminDelete.php?id=<?php echo $row['id']; ?>" class="ln">Delete</a></td>
 </tr>
 <?php
 }
}
...
<?php 
        ...
        if( $currentpage > 1 && $currentpage <= $totalpage)
          {
            ...
            $prev = $currentpage-1;
            echo "<li><a  href='adminTable.php?page=".$prev."'></a></li>";
    ...
    $prev = $currentpage-1;
      ...
      {
        $nxt = $currentpage+1;
        echo "<li><a  href='adminTable.php?page=".$nxt."' ></a></li>";
      }
