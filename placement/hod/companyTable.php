...
<head>
        ...
        <style type="text/css">
          ...
          .tab{width:400px; height:50px; margin: auto;margin-top:40px; border-radius: 30px;}
...
if($result->num_rows != 0){
 ...
 <!--cedit option -->
 <td><a href="cedit.php?edit_id=<?php echo $row['id']; ?>" alt="edit" class="ln">Update</a><a href="cdelete.php?id=<?php echo $row['id']; ?>" class="ln">Delete</a></td>
 </tr>
 <?php
 }
}
...
<?php 
        ...
        if( $currentpage > 1 && $currentpage <= $totalpage)
          {
            ...
            $prev = $currentpage-1;
            echo "<li><a  href='companyTable.php?page=".$prev."'></a></li>";
    ...
    $prev = $currentpage-1;
      for ($i=$prev+1; $i<=$currentpage+2; $i++){
        echo "<li><a href='companyTable.php?page=".$i."'>".$i."</a></li>";
      }
      }
      ...
      {
        $nxt = $currentpage+1;
        echo "<li><a  href='companyTable.php?page=".$nxt."' ></a></li>";
      }
