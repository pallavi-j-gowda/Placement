...
<br/>
<h2 style="text-align:center;" >Enter Your Details</h2><br/>
<form action="sinsert.php" method="post">
<table style="margin:auto;">
  <div class="row form-group">
    <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td><label class="text-muted font-weight-bold">USN</label></td>
    <td><input type="text" class="tab" name="id" ></td>
    <td><label class="text-muted font-weight-bold">STUDENT NAME</label></td>
    <td><input type="text" class="tab" name="username" ></td>
    </div>
    </tr>
    <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td><label class="text-muted font-weight-bold">Father name</label></td>
    <td><input type="text" class="tab" name="fathername" ></td>
    <td><label class="text-muted font-weight-bold">Mother name</label></td>
    <td><input type="text" class="tab" name="mothername"  ></td>
    </div>
    </tr>  
    <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td><label class="text-muted font-weight-bold">Date of brith</label></td>
    <td><input type="date" class="tab" name="dob" ></td>
    <td><label class="text-muted font-weight-bold">Phone Number</label></td>
    <td><input type="text" class="tab" name="phoneno" ></td>
    </div>
    </tr>
    <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td><label class="text-muted font-weight-bold">EMAIL</label></td>
    <td><input type="text" class="tab" name="email"  ></td>
    <td><label class="text-muted font-weight-bold">Address</label></td>
    <td><input type="text" class="tab" name="address"  ></td>
    </div>
    </tr>
    <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td><label class="text-muted font-weight-bold">branch</label></td>
    <td><select class="tab" name="branch" required>
    ...
    <td><label class="text-muted font-weight-bold">semester</label></td>
    <td><select class="tab" name="sem" required>
                             <option selected></option>
                             <option>1</option>
                             <option>2</option>
                             <option>3</option>
  ...
  <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td><label class="text-muted font-weight-bold">Aggregate</label></td>
    <td><input type="text" class="tab" name="aggre"  ></td>
    <td><label class="text-muted font-weight-bold">Password</label></td>
    <td><input type="password" class="tab" name="password" ></td>
    </div>
  </tr>
  <tr>
    <div class="col-lg-6 col-md-6 form-group">
    <td></td>
    <td><button type="submit" name="save" class="ln btn btn-primary">Register</button></td>
    <td></td>
    <td><a href="slogin.php"  class="ln btn btn-primary" class="text-center">Cancel</a></td>
    <td></td>
    </div>
  </tr>  
  </div>   
