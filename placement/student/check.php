...
$sqli = "SELECT * FROM updatedrive DESC LIMIT $start_from, $num_rec_per_page"; 
...
$name= $_POST['name'];
$cname= $_POST['cname'];
$sqli = "SELECT * FROM updatedrive where usn='$usn' and name='$name' and cname='$cname'" ; 
 //run the query
...
print "<tr><h2>Drive result</h2></tr>" ;
print "<br/>";
print "<tr>"; 
...
<?php 
        ...
        if( $currentpage > 1 && $currentpage <= $totalpage)
          {
            ...
            $prev = $currentpage-1;
            echo "<li><a  href='check.php?page=".$prev."'></a></li>";
    ...
    $prev = $currentpage-1;
      for ($i=$prev+1; $i<=$currentpage+2; $i++){
        echo "<li><a href='check.php?page=".$i."'>".$i."</a></li>";
      }
      }
      ...
      {
        $nxt = $currentpage+1;
        echo "<li><a  href='check.php?page=".$nxt."' ></a></li>";
      }
