...
<br/>
<h2 align="center">Students details Details</h2>
...
<?php 
        ...
        if( $currentpage > 1 && $currentpage <= $totalpage)
          {
            ...
            $prev = $currentpage-1;
            echo "<li><a  href='viewdrive.php?page=".$prev."'></a></li>";
    ...
    $prev = $currentpage-1;
      ...
      {
        $nxt = $currentpage+1;
        echo "<li><a  href='viewdrive.php?page=".$nxt."' ></a></li>";
      }
