...
if(isset($_POST['save']))
{
    ...
    $sql=mysqli_query($link,"SELECT * FROM student WHERE id='$id'  and Password='$pass'");
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3a4750;" >
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02"style="margin-left:200px;">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item active"><a  class="link nav-link" href="slogin.php"><i class="fa fa-user"></i>Student login</a> </li>
...
<h2>Login</h2><p>Please fill in your credentials to login.</p></td>
        <table class="tab">
            <tr>
                ...
                <td><input type="text" class="tab1" name="id" placeholder="usn" required="required"></td>
            </tr>
            <tr>
            ...
            <td><a href="ss.php" class="ln btn btn-primary">Sign up</a></td></tr>
        </table>
</form>
