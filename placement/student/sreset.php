          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item active dropdown">
                <a class="nav-link dropdown-toggle" href="" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fa fa-fw fa-user"></i>Drives
                </a>
              ...
              <li class="nav-item active dropdown">
                <a class="nav-link dropdown-toggle" href="../Drives/index.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fa fa-fw fa-user"></i>Placement
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li> <a class="nav-link active" href="studentProfile.php"><i class="fa fa-address-book" aria-hidden="true"></i>My Account</a></li>
  
                <li> <a  class="nav-link active" href="logout.php""><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a></li>
            </li>
            </ul>
          </div>
        </nav>
    ...
    <div >
        ...
        <table class="theme">
            ...
            <tr>
                ...
                <td><a class="btn btn-link" href="studentProfile.php">Cancel</a>
            </div></td>
            </tr>
        </table>     
        </form>
